...
void for_Xn_and_Xp(int *xn, int *xp)
{
...
int main()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        fxii=forFxi(&xii, coff);
            ...
            cout << "Iteration :\t" << +1 << "| xi : " << xi << "\t| x(i+1) :\t" << xii << "\t|f(x+1)\t" << fxii << endl;
            xi=xii;
       
    }

    cout << "Therefore the approximate  by newton raphson method is root is "<< xii <<endl;
